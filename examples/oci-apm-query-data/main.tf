...
locals {
  ocir_repo_name         = "apm-data-querier-repository"
  function_name          = "apm-data-querier"
...
resource "oci_functions_application" "this" {
  ...
  display_name   = "apm-data-querier-app"
...
resource "oci_identity_policy" "gtw_policy" {
  provider       = oci.home
  compartment_id = var.compartment_ocid
  name           = "apm-data-querier-gtway-policy"
...
resource "oci_apigateway_gateway" "function_gateway" {
    display_name = "apm-data-querier-gateway"
    compartment_id = var.compartment_ocid
...
resource "oci_apigateway_deployment" "fnc_gtw_deployment" {
  ...
  path_prefix    = "/v1"
  display_name   = "apm-data-querier-gateway-deployment"
  specification {
    routes {
      backend {
